defmodule BoundedAuthorityReportAdapter.DurableIdentifierPolicy do
  ...
  @external_v1_paths MapSet.new([
                       ...
                       "test/bounded_authority_report_adapter/role_attestation_corpus_test.exs",
                       "test/bounded_authority_report_adapter/sign_grant_role_attestation_test.exs",
                       ...
                       "test/support/bounded_authority_report_adapter/conformance/role_attestation_case.ex",
